...
def flash_cycles(energy = {}, n = 0, flash_count = 0, flash_round = 0):
    if flash_round == len(energy): 
        print("Cycle: ", n)
        ...
        print("Coordinates, flashed: ", len(flashed))
        print("Total coordinates: ", len(energy))
        flash_round = len(flashed)
        n+=1
    return flash_cycles(energy, n, flash_count, flash_round)
...
flash_cycles(energy = octo_energy)
